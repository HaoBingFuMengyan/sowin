layui.config({
	...
	$.get("/static/layui-admin/json/newsList.json",
		function(data){
			var waitNews = [];
	...
	//图片总数
	$.get("/static/layui-admin/json/images.json",
		function(data){
	...
	//用户数
	$.get("/static/layui-admin/json/usersList.json",
		function(data){
	...
	//新消息
	$.get("/static/layui-admin/json/message.json",
		function(data){
	...
	if(window.sessionStorage.getItem("systemParameter")){
		...
		$.ajax({
			url : "/static/layui-admin/json/systemParameter.json",
			type : "get",
			dataType : "json",
