...
layui.use(['form','jquery',"layer"],function() {
    ...
    if(window.sessionStorage.getItem('userFace') &&  $(".userAvatar").length > 0){
        ...
        $("#userFace").attr("src","/static/layuicms2.0/images/face.jpg");
    }
    ...
    function lockPage(){
        layer.open({
            ...
            content : '<div class="admin-header-lock" id="lock-box">'+
                            '<div class="admin-header-lock-img"><img src="/static/layuicms2.0/images/face.jpg" class="userAvatar"/></div>'+
                            '<div class="admin-header-lock-name" id="lockUserName">好哥</div>'+
                            '<div class="input_btn">'+
