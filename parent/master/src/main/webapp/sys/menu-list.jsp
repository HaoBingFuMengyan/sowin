    ...
    <div class="ibox">
        ...
        <div class="ibox-content">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="pull-left">
                        <a onclick="openlog('新增菜单','${ctx}/sys/menu/detail.shtml','1000px','500px');" class="btn btn-white btn-sm"><i class="fa fa-plus"></i>添加</a>
            ...
            <table id="treeTable"
                ...
                <tbody>
                <c:forEach items="${list.content}" var="menu">
                    <tr id="${menu.id}" pId="${menu.sparentid ne '0'?menu.sparentid:'0'}">
                        <td> <input type="checkbox" id="${menu.id}" value="${menu.id}" class="i-checks"></td>
                        <td nowrap><i class="icon-menu.icon"></i><a onclick="openlogView('查看菜单', '${ctx}/dt/menu/detail.shtml?id=${menu.id}','1000px', '500px')">${menu.sname}</a></td>
