...
<head>
    ...
    <link rel="stylesheet" href="/static/BeginnerAdmin/plugins/layui/css/layui.css" media="all">
    <link rel="stylesheet" type="text/css" href="http://www.jq22.com/jquery/font-awesome.4.6.0.css">
    <link rel="stylesheet" href="/static/BeginnerAdmin/build/css/app.css" media="all">
    <link rel="stylesheet" href="/static/BeginnerAdmin/build/css/themes/blue.css" media="all">
</head>
...
<body class="kit-theme">
    <div class="layui-layout layui-layout-admin kit-layout-admin">
        <div class="layui-header">
            ...
            <ul class="layui-nav layui-layout-right kit-nav">
                ...
                <li class="layui-nav-item"><a href="/logout.shtml"><i class="fa fa-sign-out" aria-hidden="true"></i> 注销</a></li>
            </ul>
        </div>
    ...
    <script src="/static/BeginnerAdmin/plugins/layui/layui.js"></script>
    <script>
        var message;
        layui.config({
            base: 'build/js/'
            ...
            $('#pay').on('click', function() {
                layer.open({
                    title: false,
                    type: 1,
                    content: '<img src="/static/BeginnerAdmin/build/images/pay.png" />',
                    area: ['500px', '250px'],
                    shadeClose: true
                });
            });
