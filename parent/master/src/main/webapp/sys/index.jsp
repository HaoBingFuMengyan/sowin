...
<head>
    ...
    <link rel="icon" href="${ctxStatic}/layuicms2.0/favicon.ico">
    <link rel="stylesheet" href="${ctxStatic}/layuicms2.0/layui/css/layui.css" media="all" />
    <link rel="stylesheet" href="${ctxStatic}/layuicms2.0/css/index.css" media="all" />
</head>
...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main mag0">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="${ctxStatic}/layuicms2.0/images/face.jpg" class="layui-nav-img userAvatar" width="35" height="35"><cite class="adminName">HaoSHI有限公司</cite></a>
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="${ctx}/logout.shtml" class="signOut"><i class="seraph icon-tuichu"></i><cite>退出</cite></a></dd>
                    </dl>
                </li>
            </ul>
        </div>
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像" ><img src="${ctxStatic}/layuicms2.0/images/face.jpg" class="userAvatar"></a>
            <p>你好！<span class="userName">好哥</span>, 欢迎登录</p>
        </div>
        <!-- 搜索 -->
        ...
        <div class="navBar layui-side-scroll" id="navBar">
            <ul class="layui-nav layui-nav-tree">
                <li class="layui-nav-item layui-this">
                    <a href="javascript:;" data-url="${ctx}/main.shtml"><i class="layui-icon" data-icon=""></i><cite>后台首页</cite></a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="layui-footer footer">
        <p><span>copyright @2018 HaoSHI有限公司</span>　　<a onclick="donation()" class="layui-btn layui-btn-danger layui-btn-sm">捐赠作者</a></p>
    </div>
</div>
...
<script type="text/javascript" src="${ctxStatic}/layuicms2.0/layui/layui.js"></script>
<script type="text/javascript" src="${ctxStatic}/layuicms2.0/js/index.js"></script>
<script type="text/javascript" src="${ctxStatic}/layuicms2.0/js/cache.js"></script>
</body>
</html>